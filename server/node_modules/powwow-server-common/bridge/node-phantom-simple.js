...
exports.create = function (options, callback) {
  ...
  function spawnPhantom (callback) {
    ...
    args.push(path.join(__dirname, 'bridge.js'));
    // Bridge parameter - currenly the user agent replacement string.
    if(options.bridgeparameter) {
      args.push(options.bridgeparameter);
    }
