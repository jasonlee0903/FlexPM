...
<head>
    ...
    <script>
        ...
        function openConnection() {
            ...
            var rpcUrl = webSocketProtocol + webSocketHost;
...
<body>
    <div>
        ...
        <div id="sendMessageArea" style="display:none;">
            <div style="margin-top:10px">Method: <input type="text" style="width:320px" placeholder="Enter message..." id="method" value=""></input>
                <button
                    id="sendButton" onclick="sendMessage()">Send</button>
            </div>
            <div>Params:</div>
